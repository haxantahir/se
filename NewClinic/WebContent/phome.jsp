...
<!-- Custom Fonts -->
<link href="CMS/font-awesome/css/font-awesome.min.css" rel="stylesheet"
	type="text/css">
<link
	...
	<%
		...
		try {
			...
			Connection con = DriverManager.getConnection(
					"jdbc:mysql://localhost/clinic?", "root", "root");

			Statement stmt = con.createStatement();
			String sql = "select * from reservation where patientemail='"
					+ application.getAttribute("myemail").toString() + "'";
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=rs.getString("clinicaddress")%></td>
					<td><%=rs.getString("date")%></td>
					<td><%=rs.getString("reservedtime")%></td>
					<td><%=rs.getString("cancelstate")%></td>
					<td><a href="Dsearch?action=delete&id=<%=rs.getString("idreservation")%>">Delete Appointment</a></td>
					</div>
					<%
						}
